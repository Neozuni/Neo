...
public class MemberDAO {
	...
	private MemberDAO(){
		...
		try {
			Context cs= new InitialContext();
			 ds=(DataSource) cs.lookup("java:comp/env/jdbc/oracleDB");
	...
	public MemberVO findByIdMember(String id, String password)throws SQLException{
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		MemberVO vo = null;
	...
	public ArrayList<MemberVO> findAllMember()throws SQLException{
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
